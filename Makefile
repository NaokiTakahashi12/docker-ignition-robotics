...
# Image type
BINALY := binary
BINALY_CUDAGL_110 := $(BINALY)-with-cudagl-11.0
BINALY_CUDAGL_102 := $(BINALY)-with-cudagl-10.2
BINALY_CUDAGL_92 := $(BINALY)-with-cudagl-9.2
DEVEL := devel
DEVEL_CUDAGL_110 := $(DEVEL)-with-cudagl-11.0
...
BINARY_FOCAL_DOME_TAG := $(DOME)-$(FOCAL)
...
BINARY_CUDAGL_110_FOCAL_DOME_TAG := $(DOME)-cudagl-11.0-$(FOCAL)
BINARY_CUDAGL_110_FOCAL_CITADEL_TAG := $(CITADEL)-cudagl-11.0-$(FOCAL)
...
DEVEL_FOCAL_DOME_TAG := $(DOME)-$(DEVEL)-$(FOCAL)
DEVEL_FOCAL_CITADEL_TAG := $(CITADEL)-$(DEVEL)-$(FOCAL)
...
DEVEL_CUDAGL_110_FOCAL_DOME_TAG := $(DOME)-$(DEVEL)-cudagl-11.0-$(FOCAL)
DEVEL_CUDAGL_110_FOCAL_CITADEL_TAG := $(CITADEL)-$(DEVEL)-cudagl-11.0-$(FOCAL)
DEVEL_CUDAGL_110_FOCAL_BUILD_ENV_TAG := $(BUILD_ENV)-cudagl-11.0-$(FOCAL)
...
build: \
	...
	$(DEVEL_FOCAL_DOME_TAG) \
	$(DEVEL_FOCAL_CITADEL_TAG) \
	$(DEVEL_BIONIC_DOME_TAG) \
	$(DEVEL_BIONIC_CITADEL_TAG) \
	$(DEVEL_BIONIC_BLUEPRINT_TAG) \
	$(DEVEL_CUDAGL_110_FOCAL_DOME_TAG) \
	$(DEVEL_CUDAGL_110_FOCAL_CITADEL_TAG) \
...
$(BINARY_FOCAL_DOME_TAG): $(BINALY)/$(FOCAL)/$(DOME)/$(DOCKERFILE)
...
$(BINARY_CUDAGL_110_FOCAL_DOME_TAG): $(BINALY_CUDAGL_110)/$(FOCAL)/$(DOME)/$(DOCKERFILE)
	$(eval DOCKERIMAGE := "$(USERNAME)/$(PROJECT):$@")
	$(call dockerbuild, $<, $(DOCKERIMAGE))

$(BINARY_CUDAGL_110_FOCAL_CITADEL_TAG): $(BINALY_CUDAGL_110)/$(FOCAL)/$(DOME)/$(DOCKERFILE)
	$(eval DOCKERIMAGE := "$(USERNAME)/$(PROJECT):$@")
	$(call dockerbuild, $<, $(DOCKERIMAGE))
...
$(DEVEL_FOCAL_DOME_TAG): $(DEVEL)/$(FOCAL)/$(DOME)/$(DOCKERFILE) $(DEVEL_FOCAL_BUILD_ENV_TAG)
	$(eval DOCKERIMAGE := "$(USERNAME)/$(PROJECT):$@")
	$(call dockerbuild, $<, $(DOCKERIMAGE))

$(DEVEL_FOCAL_CITADEL_TAG): $(DEVEL)/$(FOCAL)/$(CITADEL)/$(DOCKERFILE) $(DEVEL_FOCAL_BUILD_ENV_TAG)
	$(eval DOCKERIMAGE := "$(USERNAME)/$(PROJECT):$@")
	$(call dockerbuild, $<, $(DOCKERIMAGE))
...
$(DEVEL_CUDAGL_110_FOCAL_DOME_TAG): $(DEVEL_CUDAGL_110)/$(FOCAL)/$(DOME)/$(DOCKERFILE) $(DEVEL_CUDAGL_110_FOCAL_BUILD_ENV_TAG)
	$(eval DOCKERIMAGE := "$(USERNAME)/$(PROJECT):$@")
	$(call dockerbuild, $<, $(DOCKERIMAGE))

$(DEVEL_CUDAGL_110_FOCAL_CITADEL_TAG): $(DEVEL_CUDAGL_110)/$(FOCAL)/$(CITADEL)/$(DOCKERFILE) $(DEVEL_CUDAGL_110_FOCAL_BUILD_ENV_TAG)
	$(eval DOCKERIMAGE := "$(USERNAME)/$(PROJECT):$@")
	$(call dockerbuild, $<, $(DOCKERIMAGE))

$(DEVEL_CUDAGL_110_FOCAL_BUILD_ENV_TAG): $(DEVEL_CUDAGL_110)/$(FOCAL)/$(BUILD_ENV)/$(DOCKERFILE)
	$(eval DOCKERIMAGE := "$(USERNAME)/$(PROJECT):$@")
	$(call dockerbuild, $<, $(DOCKERIMAGE))
...
.PHONY: clean
clean:
	@docker image rm $(USERNAME)/$(PROJECT):$(BINARY_FOCAL_DOME_TAG)
	...
	@docker image rm $(USERNAME)/$(PROJECT):$(BINARY_CUDAGL_110_FOCAL_DOME_TAG)
	@docker image rm $(USERNAME)/$(PROJECT):$(BINARY_CUDAGL_110_FOCAL_CITADEL_TAG)
	...
	@docker image rm $(USERNAME)/$(PROJECT):$(DEVEL_FOCAL_DOME_TAG)
	@docker image rm $(USERNAME)/$(PROJECT):$(DEVEL_FOCAL_CITADEL_TAG)
	...
	@docker image rm $(USERNAME)/$(PROJECT):$(DEVEL_CUDAGL_110_FOCAL_DOME_TAG)
	@docker image rm $(USERNAME)/$(PROJECT):$(DEVEL_CUDAGL_110_FOCAL_CITADEL_TAG)
	@docker image rm $(USERNAME)/$(PROJECT):$(DEVEL_CUDAGL_110_FOCAL_BUILD_ENV_TAG)
...
.PHONY: pull
pull:
	@docker pull $(USERNAME)/$(PROJECT):$(BINARY_FOCAL_DOME_TAG)
	...
	@docker pull $(USERNAME)/$(PROJECT):$(BINARY_CUDAGL_110_FOCAL_DOME_TAG)
	@docker pull $(USERNAME)/$(PROJECT):$(BINARY_CUDAGL_110_FOCAL_CITADEL_TAG)
	...
	@docker pull $(USERNAME)/$(PROJECT):$(DEVEL_FOCAL_DOME_TAG)
	@docker pull $(USERNAME)/$(PROJECT):$(DEVEL_FOCAL_CITADEL_TAG)
	...
	@docker pull $(USERNAME)/$(PROJECT):$(DEVEL_CUDAGL_110_FOCAL_DOME_TAG)
	@docker pull $(USERNAME)/$(PROJECT):$(DEVEL_CUDAGL_110_FOCAL_CITADEL_TAG)
	@docker pull $(USERNAME)/$(PROJECT):$(DEVEL_CUDAGL_110_FOCAL_BUILD_ENV_TAG)
